...
const topics: Topic[] = [
  {
    ...
    posts: [
      ...
      { title: "Folyton a teendőiden jár az agyad?", body: "Hiába végeztél a munkával, a gondolataid mégis a következő feladaton vagy a lehetséges problémákon pörögnek? A krónikus túlterheltség nem hagyja, hogy jelen légy a saját életedben. A légzésterápia és a coaching segít kikapcsolni a belső riasztórendszeredet, hogy végre megérkezhess a jelenbe és valóban átéld a pillanatot.", tags: ["túlterheltség", "mindfulness", "stresszoldás"] },
    ],
  },
  {
    id: "legzes",
    ...
    posts: [
      ...
      { title: "Érzed, hogy felületesen veszed a levegőt?", body: "Amikor rohanunk vagy feszültek vagyunk, a légzésünk felszínessé és kapkodóvá válik — ezzel pedig tudat alatt folyamatos készenlétben tartjuk a testünket. A légzésterápia során megtanulunk újra mélyen, természetesen lélegezni, ami azonnal megnyugtatja az idegrendszert és visszaállítja a belső egyensúlyt.", tags: ["tudatoslégzés", "idegrendszer", "öngondoskodás"] },
    ],
  },
  {
    id: "coaching",
  ...
  },
  {
    ...
    posts: [
      ...
      { title: "Úgy érzed, neked kellett Édesanyád érzelmi biztonságának lenned?", body: "Ha gyerekként neked kellett gondoskodnod az Édesanya érzelmi jóllétéről, felnőttként is folyamatosan felelősnek érezheted magad mások hangulatáért. Ez a szerepcsere elrabolta a gondtalan gyerekkorodat. Légzésterápiával és coachinggal leteheted ezt a régi, túlzott felelősséget, és végre a saját életedre fókuszálhatsz.", tags: ["anyaiseb", "szerepcsere", "önismeret"] },
    ],
  },
  {
    id: "apa",
